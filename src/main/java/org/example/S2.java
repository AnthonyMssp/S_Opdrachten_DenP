-- ------------------------------------------------------------------------
        ...
        (cursus, begindatum, docent, locatie) VALUES ('S02', '2024-03-02', 7369, 'Leerdam')
        ...
        (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd) VALUES (8048, 'Knoop', 'A', 'STAGIAR', 7839, '2000-01-01', 300, NULL, 10);
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        ...
        INSERT INTO schalen
        (snr, ondergrens, bovengrens, toelage) VALUES (6, 3001, 4000, 500)
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        ...
        (code, omschrijving, type, lengte) VALUES ('D&P', 'Data & Persistency', 'ALG', 6)
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        INSERT INTO uitvoeringen
        (cursus, begindatum, docent, locatie) VALUES ('D&P', '2024-06-22', 7369, 'Leerdam')
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        INSERT INTO uitvoeringen
        (cursus, begindatum, docent, locatie) VALUES ('D&P', '2024-05-22', 7369, 'Leerdam')
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        INSERT INTO inschrijvingen
        (cursist, cursus, begindatum, evaluatie) VALUES (7499, 'D&P', '2024-06-22', NULL)
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        INSERT INTO inschrijvingen
        (cursist, cursus, begindatum, evaluatie) VALUES (7839, 'D&P', '2024-06-22', NULL)
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]
        ...
        --UPDATE medewerkers set maandsal=1.07*maandsal WHERE mnr = 7698;
        --UPDATE medewerkers set maandsal=1.05*maandsal WHERE functie = 'VERKOPER';
        ...
        -- ALDERS heeft nog een FK connectie die eerst verwijderd zal moeten worden.
        ...
        (anr, naam, locatie, hoofd) VALUES (50, 'FINANCIEN', 'LEERDAM', 7902)
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]

        INSERT INTO medewerkers
        (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd) VALUES ('8002', 'ANTHONY', 'AR', 'MANAGER', NULL, '1998-05-22', 5000, NULL, 50)
        ON CONFLICT DO NOTHING;                                                                                          --[TEST]

        --UPDATE afdelingen SET hoofd = 8002 WHERE hoofd = 7902;
