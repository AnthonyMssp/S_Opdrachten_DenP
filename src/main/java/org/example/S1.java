-- Data & Persistency
        ...
        INSERT INTO afdelingen (anr, naam, locatie, hoofd) VALUES (50, 'ONDERZOEK', 'ZWOLLE', 7788);
        INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd) VALUES (8000, 'DONK', 'A', 'directeur', 7839, '1974-06-16', 5000, 0.00, 50);
        ...
        INSERT INTO afdelingen (anr, naam, locatie, hoofd) VALUES (nextval('id_sequence'), 'TEST', 'MADAGASCAR', 7788);
        ...
        postcode VARCHAR(6) CHECK (postcode ~ '^[0-9]{4}[A-Za-z]{2}$') NOT NULL,
        huisnummer VARCHAR(10) NOT NULL,
        ingangsdatum DATE NOT NULL,
        einddatum DATE NOT NULL,
        telefoon CHAR(10) CHECK (telefoon ~ '^[0-9]{10}$') NOT NULL,
        med_mnr NUMERIC(4, 0) NOT NULL,
        PRIMARY KEY (postcode, huisnummer, ingangsdatum),
        FOREIGN KEY (med_mnr) REFERENCES medewerkers(mnr)
        );

        INSERT INTO adressen (postcode, huisnummer, ingangsdatum, einddatum, telefoon, med_mnr) VALUES ('3597ZC', '10', '2020-03-12', '2023-09-12', '0612345678', 8000)
        ...
        ADD CONSTRAINT check_commissie
